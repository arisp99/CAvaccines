...
```{r}
map_plot(county_vaccination, "avg_DTP", "Average DTP Vaccination Rates", breaks = seq(50, 70, 5))

map_plot(county_vaccination, "avg_Up_to_Date", "Average Up to Date Rates", breaks = seq(55, 80, 5))

map_plot(county_vaccination, "avg_PME", "Average PME Rates", breaks = seq(0, 35, 5))

map_plot(county_vaccination, "avg_PBE", "Average PBE Rates", breaks = seq(0, 5, 1))
```
