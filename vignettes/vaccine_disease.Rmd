...
data from 2013 spans a large range, we will tranform the shading of the map by
log base 2. This will make it easier to inteprept. Note that when we transform
