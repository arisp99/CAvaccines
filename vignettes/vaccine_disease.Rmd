...
#### Incidence
We first start with our `pertussis` dataset. One way to visualise our data is
...
# Map with all data
suppressMessages(map_plot(pertussiss_to_map, 
                          "Rates", 
...
map_plot(pertussiss_to_map %>% dplyr::filter(Rates < 25), 
         "Rates", 
         "Rates Per 100,000 Individuals In 2013",
         "Rates")
```
