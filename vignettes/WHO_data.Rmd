...
population_country <- suppressMessages(
  readxl::read_excel("/Users/arisp/Desktop/population-by-country.xlsx",
                     na = "",
                     range = "B2:D191",
                     col_names = FALSE))
...
incidence_series <- suppressMessages(
  readxl::read_excel("/Users/arisp/Desktop/incidence_series.xls",
                     sheet = "Pertussis",
                     na = "",
                     col_names = TRUE))
...
coverage_series <- suppressMessages(
  readxl::read_excel("/Users/arisp/Desktop/Numeric_coverage_series.xls",
